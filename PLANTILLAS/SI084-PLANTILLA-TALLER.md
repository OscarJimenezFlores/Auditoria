...
Este es el formato en el que se entrega **todo informe de taller de SI-084**. Se llena en Word y se entrega en **PDF**.

1. Guarda una copia con el nombre **`SI084-S<NN>-TALLER-Grupo<N>.pdf`**. Por ejemplo, `SI084-S03-TALLER-Grupo4.pdf`.
